...
TEST(ZombieTest,getAllDamageTypes){
    Zombie z;
    Weapon *w=new Weapon();
    ...
    //Adding a damage Boost to Zombie
...
TEST(ZombieTest,GetAllResistance){
    Zombie z;
    Weapon *w=new Weapon();
